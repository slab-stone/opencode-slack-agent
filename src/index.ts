...
/**
 * OpenCode Slack MCP Server — Entry Point
 *
 * Provides Slack communication tools for OpenCode agents.
 * Uses Socket Mode for real-time event reception from Slack.
 */
...
async function main() {
  ...
  // Start Socket Mode for real-time event reception
